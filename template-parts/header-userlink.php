    ...
    <li class="menu-item menu-item-has-children dropdown switcher-login">
		...
		<?php else: ?>
            <ul class="submenu dropdown-menu">
                <li>
                    <a href="<?php echo wp_logout_url( get_permalink() ); ?>"><?php esc_html_e( 'Logout', 'casano' ); ?></a>
                </li>
            </ul>
		<?php endif; ?>
    </li>
    ...
    <li class="menu-item dropdown switcher-login">
        <a href="<?php echo esc_url( $myaccount_link ); ?>">
			<?php if ( $woocommerce_enable_myaccount_registration == "yes" ) : ?>
				<?php echo esc_html__( 'Register / Sign in', 'casano' ); ?>
			<?php else: ?>
				<?php echo esc_html__( 'Login', 'casano' ); ?>
			<?php endif; ?>
        </a>
    </li>
<?php endif; ?>