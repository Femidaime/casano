...
<div class="casano-minicart casano-no-cache">
    ...
    <span class="mini-cart-icon">
        ...
        <span class="minicart-number"><?php printf( esc_html__( '%1$s', 'casano' ), WC()->cart->cart_contents_count ); ?></span>
    </span>
            ...
            <div class="minicart-content-inner">
                <h3 class="minicart-title">
                    ...
                    <span class="minicart-title-inner">
                        <?php echo esc_html__( 'Your Cart', 'casano' ); ?>
                        <span class="minicart-number-items">
                            <?php printf( esc_html__( '%1$s', 'casano' ), WC()->cart->cart_contents_count ); ?>
                        </span>
                    </span>
                </h3>
                                ...
                                <li class="product-cart">
                                    ...
                                    <div class="product-detail">
                                        ...
                                        <div class="product-detail-info">
                                            <span class="product-quantity"><?php printf( esc_html__( 'QTY : %1$s', 'casano' ), $cart_item['quantity'] ); ?></span>
                ...
                <div class="subtotal">
                    <span class="total-title"><?php echo esc_html__( 'Totals ', 'casano' ); ?></span>
                ...
                <div class="actions">
                    <a class="button button-viewcart" href="<?php echo esc_url( wc_get_cart_url() ); ?>">
                        <span><?php esc_html_e( 'View Cart', 'casano' ); ?></span>
                    </a>
                    <a href="<?php echo esc_url( wc_get_checkout_url() ); ?>"
                       class="button button-checkout"><span><?php echo esc_html__( 'Checkout', 'casano' ); ?></span></a>
                </div>
            </div>
        </div>
	<?php else : ?>
                ...
                <div class="minicart-list-items">
                    <div class="empty-wrap">
                        <div class="empty-title">
                            <span><?php esc_html_e( 'Your shopping cart is empty.', 'casano' ); ?></span></div>
                        <a href="<?php echo esc_url( apply_filters( 'woocommerce_return_to_shop_redirect', wc_get_page_permalink( 'shop' ) ) ); ?>"
                           class="to-cart"><?php esc_html_e( 'Start shopping', 'casano' ); ?></a>
                    </div>
                </div>
            </div>
        </div>
