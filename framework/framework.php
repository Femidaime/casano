...
?>
<?php
if ( ! class_exists( 'Casano_framework' ) ) {
	class Casano_framework {
		/**
		...
		public function enqueue_scripts() {
			...
			wp_enqueue_style( 'casano-custom-admin-css', get_theme_file_uri( '/framework/assets/css/admin.css' ), array( 'cs-framework' ), '1.0' );
			wp_enqueue_script( 'casano-custom-admin-js', get_theme_file_uri( '/framework/assets/js/admin.js' ), array(), '1.0' );
		}
