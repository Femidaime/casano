...
if ( $max_value && $min_value === $max_value ) {
    ...
    <div class="quantity">
        <div class="control">
            <a class="btn-number qtyplus quantity-plus" href="#"><?php echo esc_html__('+','casano')?></a>
            <input type="text" data-step="<?php echo esc_attr( $step ); ?>"
                   ...
                   title="<?php echo esc_attr_x( 'Qty', 'Product quantity input tooltip', 'casano' ) ?>"
                   class="input-qty qty" size="4"/>
            <a class="btn-number qtyminus quantity-minus" href="#"><?php echo esc_html__('-','casano')?></a>
        </div>
    </div>
	<?php
}
